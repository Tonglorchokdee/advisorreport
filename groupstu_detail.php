    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold">รายละเอียดจัดการหมู่เรียน</h6>
            </div>
            <div class="card-body">
                        ...
                        <form action="" method="post" id="frmGroupstu">
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col text-center">
                                    <a href="groupstu_edit.php?id=<?php echo $r['groupstu_id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i> แก้ไข</a>
                                </div>
                            </div>
