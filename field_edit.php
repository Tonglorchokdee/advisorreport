    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold">แก้ไขสาขาวิชา</h6>
            </div>
            <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="กรอกชื่อสาขาวิชา" name="field_name" id="field_name" title="สาขาวิชา" value="<?php echo $r['field_name']; ?>">
                                    </div>
                                </div>
                            </div>
