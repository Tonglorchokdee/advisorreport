...
$titlepage = 'เพิ่มรายงานการปฏิบัติหน้าที่';
include '_headweb.php';

if (!isset($_POST['timereport_id'])) {
    echo '<script>Swal.fire("ข้อผิดพลาด", "เลือกเทอมและหมู่เรียน", "error").then(function() {window.location.href = "workreport_select.php"});</script>';
    exit();
}
...
$sql = 'SELECT * FROM tb_user WHERE user_id = "' . $teacher_id . '"';
...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">เพิ่มรายงานการปฏิบัติหน้าที่</h1>
        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    ...
                                    <?php
                                    $sql = 'SELECT * FROM tb_groupstu WHERE groupstu_id = ' . $groupstu_id;
                                    $rs = mysqli_query($con, $sql);
                                    $r = mysqli_fetch_array($rs);
                                    ?>
                                    <h5>หมู่เรียน : <?php echo $r['groupstu_name']; ?></h5>
                                    <?php
                                    $sql = 'SELECT * FROM tb_field WHERE field_id = ' . $field_id;
                                    $rs = mysqli_query($con, $sql);
                                    $r = mysqli_fetch_array($rs);
                                    ?>
                            ...
                            <div class="row">
                                ...
                                <font color="red"><p>หมายเหตุ :</font> หากช่องไหนไม่กรอกข้อมูล ข้อมูลจะเป็น 0</p> 
                                </div>
                            </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>รวม (คน)</label>
                                                        <input type="number" class="form-control" placeholder="รวม (คน)" name="wp_start_sum" id="wp_start_sum" title="รวม (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>ชาย (คน)</label>
                                                        <input type="number" class="form-control" placeholder="ชาย (คน)" name="wp_start_male" id="wp_start_male" title="ชาย (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>หญิง (คน)</label>
                                                        <input type="number" class="form-control" placeholder="หญิง (คน)" name="wp_start_female" id="wp_start_female" title="หญิง (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="หยุดพักการเรียน (คน)" name="wp_break" id="wp_break" title="หยุดพักการเรียน (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="ลาออก (คน)" name="wp_quit" id="wp_quit" title="ลาออก (คน)" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="พ้นสภาพ (คน)" name="wp_out" id="wp_out" title="พ้นสภาพ (คน)" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="เสียชีวิต (คน)" name="wp_died" id="wp_died" title="เสียชีวิต (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>จากสาเหตุ</label>
                                                        <input type="text" class="form-control" placeholder="จากสาเหตุ" name="wp_died_text" id="wp_died_text" title="จากสาเหตุ">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="หายไปไม่สามารถติดต่อได้ (คน)" name="wp_no_contact" id="wp_no_contact" title="หายไปไม่สามารถติดต่อได้ (คน)" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>รวม (คน)</label>
                                                        <input type="number" class="form-control" placeholder="รวม (คน)" name="wp_end_sum" id="wp_end_sum" title="รวม (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>ชาย (คน)</label>
                                                        <input type="number" class="form-control" placeholder="ชาย (คน)" name="wp_end_male" id="wp_end_male" title="ชาย (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>หญิง (คน)</label>
                                                        <input type="number" class="form-control" placeholder="หญิง (คน)" name="wp_end_female" id="wp_end_female" title="หญิง (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="จำนวน (คน)" name="wp_scholarship" id="wp_scholarship" title="จำนวนนักศึกษาที่รับทุนกู้ยืมทางการศึกษา (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="จำนวน (คน)" name="wp_scholarship_other" id="wp_scholarship_other" title="จำนวนนักศึกษาที่รับทุนอื่น ๆ (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="จำนวน (คน)" name="wp_event" id="wp_event" title="จำนวนนักศึกษาที่เข้าร่วมกิจกรรมนักศึกษา (องค์การนักศึกษา สภาฯ สโมสรนักศึกษาประจำคณะ) (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="จำนวน (คน)" name="wp_glorification" id="wp_glorification" title="จำนวนนักศึกษาที่ได้รับการเชิดชูเกียรติ (ด้านวิชาการ กีฬา ดนตรี ศิลปะ อื่น ๆ) (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="จำนวน (คน)" name="wp_lowgrade" id="wp_lowgrade" title="จำนวนนักศึกษาที่มีผลการเรียนต่ำ (ต่ำกว่า 2.00) (คน)" min="0" value="0">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <h6>2. การเข้าพบนักศึกษาในชั่วโมงที่ปรึกษา (ครั้ง)</h6>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="จำนวน (ครั้ง)" name="wp_meeting" id="wp_meeting" title="การเข้าพบนักศึกษาในชั่วโมงที่ปรึกษา (ครั้ง)" min="0" value="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label>จำนวน (ครั้ง)</label>
                                                <input type="number" class="form-control" placeholder="จำนวน (ครั้ง)" name="wp_counsel" id="wp_counsel" title="การให้คำปรึกษาเป็นรายบุคคล (ครั้ง)" min="0" value="0">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <label>จำนวน (คน)</label>
                                                <input type="number" class="form-control" placeholder="จำนวน (คน)" name="wp_counsel_count" id="wp_counsel_count" title="การให้คำปรึกษาเป็นรายบุคคล (คน)" min="0" value="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
