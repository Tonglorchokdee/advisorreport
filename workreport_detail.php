    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
                            ...
                            ?>
                                <div class="row justify-content-md-center">
                                    <div class="col text-center">
                                        ...
                                        ?>
                                            <a href="workreport_edit.php?id=<?php echo $wp_id; ?>" class="btn btn-warning"><i class="fas fa-edit"></i> แก้ไข</a>
                                        <?php
                                        } else {
                                        ?>
                                            <button type="submit" name="submit" id="submit" class="btn btn-success"><i class="fas fa-check"></i> อนุมัติ</button>
                                        <?php
                                        }
                                        ?>
                                    </div>
            ...
            <div class="card-footer">
                ...
                ?>
                    <a href="workreport_manager.php" class="btn btn-primary"><i class="fas fa-chevron-left"></i> ย้อนกลับ</a>
                <?php
                }
                ?>
            </div>
                    ...
                    success: function(data) {
                        ...
                        if (data.success == '1') {
                            ...
                            Swal.fire(data.msg, '', 'success').then(function() {
                                window.location.href = 'workreport_manager.php'
                            });
                        } else {
