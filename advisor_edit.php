...
$titlepage = 'แก้ไขอาจารย์';
include '_headweb.php';


if (!isset($_GET['id'])) {
    echo '<script>Swal.fire("ข้อผิดพลาด", "เลือกข้อมูลที่ต้องการแก้ไข", "error").then(function() {window.location.href = "advisor.php"});</script>';
    exit();
}
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold">แก้ไขอาจารย์</h6>
            </div>
            <div class="card-body">
