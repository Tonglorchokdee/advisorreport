                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="กรอกชื่อหมู่เรียน" name="groupstu_name" id="groupstu_name" title="หมู่เรียน" value="<?php echo $r['groupstu_name'] ?>">
                                    </div>
                                </div>
                            </div>
