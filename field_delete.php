                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="กรอกชื่อสาขาวิชา" name="field_name" id="field_name" title="สาขาวิชา" value="<?php echo $r['field_name']; ?>" disabled>
                                    </div>
                                </div>
                            </div>
